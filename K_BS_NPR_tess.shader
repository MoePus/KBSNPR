Shader "KBSToon/Default_Cutout_Tess"
{
	Properties
	{
		...
		//Tessellation
        _TessAmount("DX11 Tess : Edge Amount", Range(2, 50)) = 5
        _TessPhongStrength("DX11 Tess : Phong Strength", Range(0, 0.01)) = 0.0
        _TessInsideOut("DX11 Tess : InsideOut", Range(-1, 1)) = 1
	}
